...
//        Burger gh = new DeluxeBurger();
//        gh.AddOns(1);
//        gh.addExtras(new Extras("cheese"));
//        gh.myBurger();
//        Burger a = new Burger("Cheese Burger", "Whole Wheat", false);
//        a.myBurger();
//        Extras er = new Extras();
//        a.addExtras(er);
//        a.AddOns(4);
//        a.addExtras(er);
//        Extras v = new Extras("adfaf", "asdfasdf", "asdfasdf", "asddsad", "asdfads");
//        a.addExtras(v);
//        Burger b = new Burger();
//        System.out.println(b.getPrice());
//        b.AddOns(2);
//        System.out.println(b.addOns);
//        System.out.println(b.getPrice());
//
//        System.out.println(b.isMeat());
//        System.out.println(b.price);
//        System.out.println(b.getPrice());
//        System.out.println(b.getAddOns());
//        b.setPrice();
//        b.AddOns(3);
//        System.out.println(b.addOns);
//        System.out.println(b.getPrice());
//
//        Burger best = new Burger("My B", "Wheat");
//        best.myBurger();
//        best.AddOns(9);
//        best.AddOns(-7);
//        best.addExtras(new Extras("Cheese"));
//        best.AddOns(2);
//        best.addExtras(new Extras("cheese", "ketchup"));
//        Burger ve = new Burger();
//
//        ve.AddOns(4);
//        ve.myBurger();
//        ve.AddOns(6);
//        System.out.println(ve.addOns);
//        System.out.println(ve.getPrice());
//
//        Burger veggie = new HealthyBurger();
//        veggie.AddOns(3);
//        veggie.myBurger();
//        veggie.addExtras(new Extras("cheese", "mustard", "pickles"));
//
//
//        Extras g = new Extras("cheese", "kale", "pickles", "beets", "cheese", "ketchup");
//
//        veggie.addExtras(g);
//        Burger ghg = new HealthyBurger();
//        ghg.myBurger();
//        veggie.myBurger();
//        ghg.addExtras(g);
//        ghg.myBurger();
